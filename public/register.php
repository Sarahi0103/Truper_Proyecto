    ...
    <div class="login-container">
        <div class="auth-shell">
            <aside class="auth-side">
                ...
                <h2>Comienza hoy</h2>
                <p>Regístrate para acceder a catálogo, pedidos, promociones de cumpleaños y herramientas de gestión.</p>
                <ul>
                    <li>Registro rápido para clientes</li>
                    <li>Bonos y beneficios personalizados</li>
                    <li>Seguimiento de compras y estatus</li>
                </ul>
            </aside>

            <div class="auth-form-wrap">
                <div class="login-box" style="max-width: 560px; margin: 0 auto;">
